 ...
 */
package com.jxtii.oa.modules.act.service;
...
import com.jxtii.oa.modules.act.dao.ActDao;
import com.jxtii.oa.modules.act.entity.Act;
import com.jxtii.oa.modules.act.service.cmd.CreateAndTakeTransitionCmd;
import com.jxtii.oa.modules.act.service.cmd.JumpTaskCmd;
import com.jxtii.oa.modules.act.service.creator.ChainedActivitiesCreator;
import com.jxtii.oa.modules.act.service.creator.MultiInstanceActivityCreator;
import com.jxtii.oa.modules.act.service.creator.RuntimeActivityDefinitionEntityIntepreter;
import com.jxtii.oa.modules.act.service.creator.SimpleRuntimeActivityDefinitionEntity;
import com.jxtii.oa.modules.act.utils.ActUtils;
import com.jxtii.oa.modules.act.utils.ProcessDefCache;
import com.jxtii.oa.modules.act.utils.ProcessDefUtils;
...
//			e.setProcExecUrl(ActUtils.getProcExeUrl(task.getProcessDefinitionId()));
     ...
     * @return
     */
    public Page<Act> historicPage(Page<Act> page, Act act) {
        String userId = UserUtils.getUser().getLoginName();//ObjectUtils.toString(UserUtils.getUser().getId());
