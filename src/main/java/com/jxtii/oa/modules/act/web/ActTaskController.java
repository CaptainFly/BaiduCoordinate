 ...
 */
package com.jxtii.oa.modules.act.web;
...
import com.jxtii.oa.modules.act.service.ActTaskService;
...
public class ActTaskController extends BaseController {
    ...
    public String historicList(Act act, HttpServletRequest request, HttpServletResponse response, Model model) throws Exception {
        ...
        page = actTaskService.historicPage(page, act);
...
//		return "modules/act/actTaskForm";
     ...
     *                  vars.keys=flag,pass
     *                  vars.values=1,true
     *                  vars.types=S,B  @see com.jxtii.oa.modules.act.utils.PropertyType
     */
