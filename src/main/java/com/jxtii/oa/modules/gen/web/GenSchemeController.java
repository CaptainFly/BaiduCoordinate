 ...
 */
package com.jxtii.oa.modules.gen.web;
...
import com.jxtii.oa.modules.gen.entity.GenScheme;
import com.jxtii.oa.modules.gen.service.GenSchemeService;
import com.jxtii.oa.modules.gen.service.GenTableService;
import com.jxtii.oa.modules.gen.util.GenUtils;
...
public class GenSchemeController extends BaseController {
    ...
    public String form(GenScheme genScheme, Model model) {
        if (StringUtils.isBlank(genScheme.getPackageName())) {
            genScheme.setPackageName("com.jxtii.oa.modules");
        }
