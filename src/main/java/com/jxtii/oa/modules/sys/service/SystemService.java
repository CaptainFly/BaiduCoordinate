...
import com.jxtii.oa.common.security.Digests;
import com.jxtii.oa.common.security.shiro.session.SessionDAO;
import com.jxtii.oa.common.service.BaseService;
import com.jxtii.oa.common.service.ServiceException;
import com.jxtii.oa.common.utils.*;
import com.jxtii.oa.common.web.Servlets;
import com.jxtii.oa.modules.sys.dao.MenuDao;
import com.jxtii.oa.modules.sys.dao.RoleDao;
import com.jxtii.oa.modules.sys.dao.UserDao;
...
import com.jxtii.oa.modules.sys.security.SystemAuthorizingRealm;
import com.jxtii.oa.modules.sys.utils.ConstantUtils;
import com.jxtii.oa.modules.sys.utils.LogUtils;
...
public class SystemService extends BaseService implements InitializingBean {
    ...
    public boolean isExistsUser(String loginName) {
        return UserUtils.isExists(loginName);
    }
...
//		systemRealm.clearAllCachedAuthorizationInfo();
        ...
        // 删除token
        String tokenKey = ConstantUtils.PREFIX_TOKEN + user.getLoginName();
    ...
    public void updateUserLoginInfo(User user) {
        ...
        // 更新本次登录信息
        user.setLoginIp(RequestUtils.getRemoteAddr(Servlets.getRequest()));
    ...
    public static void main(String[] args) {
        System.out.println("args = " + entryptPassword("123"));
    }
...
//		systemRealm.clearAllCachedAuthorizationInfo();
    ...
    public static boolean printKeyLoadMessage() {
        ...
        sb.append("\r\n======================================================================\r\n");
        sb.append("\r\n    欢迎使用 " + Global.getConfig("productName") + "  - Powered By http://www.jxtii.com/\r\n");
        sb.append("\r\n======================================================================\r\n");
