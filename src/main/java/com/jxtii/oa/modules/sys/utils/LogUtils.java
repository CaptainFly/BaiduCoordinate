...
public class LogUtils {
    ...
    public static void saveLog(Log log, Throwable ex) {
        new SaveAPILogThread(log, ex).start();
    }
     ...
     * 保存API日志
     */
    public static class SaveAPILogThread extends Thread {

        private Log log;
        private Throwable ex;

        public SaveAPILogThread(Log log, Throwable ex) {
            super(SaveLogThread.class.getSimpleName());
            this.log = log;
            this.ex = ex;
        }
