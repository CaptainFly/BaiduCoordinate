 ...
 */
package com.jxtii.oa.modules.sys.utils;
...
import com.jxtii.oa.modules.sys.dao.*;
import com.jxtii.oa.modules.sys.entity.*;
...
public class UserUtils {
    ...
    public static boolean isExists(String loginName) {
    ...
    public static List<Role> getRoleList() {
        ...
        if (roleList == null) {
            ...
            if (user.isAdmin()) {
                ...
                Role role = new Role();
                String dsf = BaseService.dataScopeFilter(user.getCurrentUser(), "o", "u");
                role.getSqlMap().put("dsf", dsf);
    ...
    public static List<Role> getRoleByUser(String userId) {
        List<Role> roleList = roleDao.findRolesByUser(userId);
        return roleList;
    }
    ...
    public static List<Menu> getMenuListByParentId(String pId) {
        List<Menu> menuList = null;// (List<Menu>) getCache(CACHE_MENU_LIST.concat(pId));
        if (menuList == null) {
            User user = getUser();
            Menu m = new Menu();
            m.setUserId(user.getId());
            ...
            putCache(CACHE_MENU_LIST.concat(pId), menuList);
        }
        return menuList;
    }
