<%@ page contentType="text/html;charset=UTF-8" %><meta http-equiv="Content-Type" content="text/html;charset=utf-8" /><meta name="author" content="http://www.jxtii.com/"/>
...
<link href="${ctxStatic}/common/base.css" type="text/css" rel="stylesheet" />
